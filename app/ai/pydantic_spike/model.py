"""Ruteo de id de modelo → string de proveedor de Pydantic AI.

Pydantic AI identifica el modelo con `"<provider>:<model>"`. Replicamos el ruteo
por prefijo de `app/ai/factories/base.py`, pero como string en vez de cliente.
